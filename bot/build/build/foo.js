...
}).on('replay', console.log.bind(console, 'replay')).on('progress', console.log.bind(console, 'progress')).on('error', console.log.bind(console, 'error')).on('end', console.log.bind(console, 'end'));
